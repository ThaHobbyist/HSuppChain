...
export default ({
  ...
  return getModal ? (
    <div className="fixed inset-0 z-10 overflow-y-auto ">
      <div className="fixed w-full h-full bg-black opacity-40" onClick={() => setGetModal(false)} ></div>
          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            {singleShipmentData == undefined ? (
              ...
              <div className="text-left">
                ...
                <p>Recipient: {singleShipmentData.recipient.slice(0, 25)}... </p>
                ...
                <p>Cost: {singleShipmentData.cost} </p>
